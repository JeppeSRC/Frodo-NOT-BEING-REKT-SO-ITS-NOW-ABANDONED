...
vec2& vec2::Add(const vec2& v) {
	...
	memcpy(this, xmm.m128_f32, sizeof(float) * 2);
	return *this;
}
...
ivec2& ivec2::Add(const ivec2& v) {
	...
	memcpy(this, xmm.m128i_i32, sizeof(int) * 2);
	return *this;
}

ivec2& ivec2::Add(int v) {
	__m128i xmm = _mm_set_epi32(0, 0, y, x);
