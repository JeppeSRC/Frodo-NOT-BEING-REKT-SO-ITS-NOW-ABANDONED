...
void DeferredTest::OnInit() {
	...
	Material* material = new Material(vec4(1, 1, 1, 1), (Texture2D*)TextureManager::Get("default"));
	...
	spinningLight0 = new PointLight(vec3(2, 0.0f, 0), vec3(1, 1, 1), vec3(1, 0.025, 4));
	spinningLight1 = new PointLight(vec3(-2, 0.0f, 0), vec3(0, 1, 1), vec3(1, 0.025, 4));
	spinningLight2 = new PointLight(vec3(0, 0.0f, 2), vec3(0, 0, 1), vec3(1, 0.025, 4));
	spinningLight3 = new PointLight(vec3(0, 0.0f, -2), vec3(1, 0, 0), vec3(1, 0.025, 4));
